...
function Materialedit() {
  ...
  const updateMaterial = () => {
    Axios.put('http://localhost:3001/updatematerial', {
      ...
      setMaterialList(
        materialList.map((val) => {
          return val.material_Id == material_Id ? {
            material_Id: val.material_Id,
            material_name: val.material_name,
            material_brand: val.material_brand,
            material_unit: val.material_unit,
            material_price: val.material_price,
            material_remaining: val.material_remaining,
            material_order_date: val.material_order_date,
            material_delivery_date: val.material_delivery_date,
            type_material_Id: val.type_material_Id,
    ...
    <div className="App container">
      ...
      <div className="information">
        <form action="">
          ...
          <button class="btn btn-warning" onClick={updateMaterial}>อัพเดต</button><br />
        </form>
      </div>
    </div>
  );
