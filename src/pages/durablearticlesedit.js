...
function Durablearticlesedit() {
    ...
    const updateDurablearticles = () => {
        Axios.put('http://localhost:3001/updatedurablearticles', {
            ...
            setDurablearticlesList(
                durablearticlesList.map((val) => {
                    return val.durablearticles_Id == durablearticles_Id ? {
                        durablearticles_Id: val.durablearticles_Id,
                        durablearticles_name: val.durablearticles_name,
                        durablearticles_brand: val.durablearticles_brand,
                        durablearticles_unit: val.durablearticles_unit,
                        durablearticles_price: val.durablearticles_price,
                        durablearticles_order_date: val.durablearticles_order_date,
                        durablearticles_delivery_date: val.durablearticles_delivery_date,
                        durablearticles_repair_date: val.durablearticles_repair_date,
                        durablearticles_finish_date: val.durablearticles_finish_date,
                        type_durablearticles_Id: val.type_durablearticles_Id,
        ...
        <div className="App container">
            ...
            <div className="information">
                <form action="">
                    ...
                    <button class="btn btn-warning" onClick={updateDurablearticles}>อัพเดต</button><br />
                </form>
            </div>
        </div>
    );
